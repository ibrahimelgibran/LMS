...
<!-- <div id="buynow" style="height: 45px;">
    <button class="stripe-button payment-button float-right" id="stripePayButton"><?php echo get_phrase("pay_with_dana"); ?></button>
</div> -->
<hr class="border mb-4" style="position: absolute; width: 100%; margin-top: 262px;">
<div id="buynow" style="height: 45px;">
    <button class="stripe-button payment-button float-right" id="stripePayButton"><?php echo get_phrase("pay_with_dana"); ?></button>
</div>
...
<script>
    ...
    document.getElementById("stripePayButton").addEventListener("click", function() {
        // Mengarahkan pengguna ke halaman eksternal saat tombol diklik
        window.location.href = "http://ibrahimelgibran.com";
    });
</script>
