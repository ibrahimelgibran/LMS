...
!(function (a) {
      ...
      (a.ui.pos = {
        ...
        fit: {
          left: function (b, c) {
            ...
            c.collisionWidth > h
              ? j > 0 && k <= 0
                ? ((d = b.left + j + c.collisionWidth - h - g),
                  (b.left += j - d))
                : (b.left =
                    k > 0 && j <= 0 ? g : j > k ? g + h - c.collisionWidth : g)
              : j > 0
              ? (b.left += j)
              : k > 0
              ? (b.left -= k)
              : (b.left = f(b.left - i, b.left)),
          ...
          top: function (b, c) {
            ...
            c.collisionHeight > h
              ? j > 0 && k <= 0
                ? ((d = b.top + j + c.collisionHeight - h - g),
                  (b.top += j - d))
                : (b.top =
                    k > 0 && j <= 0 ? g : j > k ? g + h - c.collisionHeight : g)
              : j > 0
              ? (b.top += j)
              : k > 0
              ? (b.top -= k)
              : (b.top = f(b.top - i, b.top)),
        ...
        flip: {
          left: function (b, c) {
            ...
            var d,
              ...
              p = -2 * c.offset[0];
            l < 0
              ? ((d = b.left + n + o + p + c.collisionWidth - i - h) < 0 ||
                  d < g(l)) &&
                (b.left += n + o + p)
              : m > 0 &&
          ...
          top: function (b, c) {
            ...
            var d,
              ...
              q = -2 * c.offset[1];
            l < 0
              ? ((e = b.top + o + p + q + c.collisionHeight - i - h) < 0 ||
                  e < g(l)) &&
                (b.top += o + p + q)
              : m > 0 &&
                ((d = b.top - c.collisionPosition.marginTop + o + p + q - j) >
                  0 ||
                  g(d) < m) &&
                (b.top += o + p + q),
  ...
  (function (a) {
    ...
    "function" == typeof define && define.amd
      ? define(["jquery"], a)
      : window.jQuery && !window.jQuery.fn.iconpicker && a(window.jQuery);
  })(function (a) {
    "use strict";
    var b = {
        isEmpty: function (a) {
      ...
      c = function (d, e) {
        (this._id = c._idCounter++),
          ...
          (this.container =
            !!b.isElement(this.options.container) && a(this.options.container)),
          !1 === this.container &&
            (this.element.is(".dropdown-toggle")
          ...
          !1 === this.input &&
            ...
            this.input.is("input,textarea") || (this.input = !1)),
    ...
    (c._idCounter = 0),
      (c.defaultOptions = {
        ...
        templates: {
          ...
          buttons:
            '<button class="iconpicker-btn iconpicker-btn-cancel btn btn-default btn-sm">Cancel</button> <button class="iconpicker-btn iconpicker-btn-accept btn btn-primary btn-sm">Accept</button>',
          search:
      ...
      (c.prototype = {
        ...
        _trigger: function (b, c) {
          (c = c || {}),
            this.element.trigger(
              a.extend({ type: b, iconpickerInstance: this }, c)
            );
        },
        _createPopover: function () {
          ...
          if (
            ...
            this.hasSeparatedSearchInput() && !this.options.searchInFooter
              ? c.append(this.options.templates.search)
              : this.options.title || c.remove(),
            ...
            this.hasSeparatedSearchInput() &&
              ...
              b.isEmpty(this.options.templates.buttons) ||
                d.append(a(this.options.templates.buttons)),
              this.popover.append(d);
          }
          return (
            !0 === this.options.animation && this.popover.addClass("fade"),
            this.popover
          );
        },
        _createIconpicker: function () {
          ...
          var c = function (c) {
            ...
            d.is("i") && (d = d.parent()),
              ...
              !1 === b.options.mustAccept
                ? (b.update(d.data("iconpickerValue")),
                  b._trigger("iconpickerSelected", {
                    iconpickerItem: this,
                    iconpickerValue: b.iconpickerValue,
                  }))
                : b.update(d.data("iconpickerValue"), !0),
              b.options.hideOnSelect && !1 === b.options.mustAccept && b.hide();
          };
            ...
            if ("string" == typeof this.options.icons[d].title) {
              ...
              if (
                (e
                  .find("i")
                  .addClass(
                    this.options.fullClassFormatter(this.options.icons[d].title)
                  ),
                e
                  .data("iconpickerValue", this.options.icons[d].title)
                  .on("click.iconpicker", c),
                this.iconpicker
                  .find(".iconpicker-items")
                  .append(e.attr("title", "." + this.options.icons[d].title)),
                this.options.icons[d].searchTerms.length > 0)
              ) {
                for (
                  var f = "", g = 0;
                  g < this.options.icons[d].searchTerms.length;
                  g++
                )
        ...
        _isEventInsideIconpicker: function (b) {
          ...
          return !(
            ...
            0 === c.parents(".iconpicker-popover").length
          );
        },
            ...
            this.hasInput() &&
              this.input.on("keyup.iconpicker", function (d) {
                b.inArray(
                  d.keyCode,
                  [
                    38, 40, 37, 39, 16, 17, 18, 9, 8, 91, 93, 20, 46, 186, 190,
                    46, 78, 188, 44, 86,
                  ]
                )
                  ? c._updateFormGroupStatus(!1 !== c.getValid(this.value))
                  : c.update(),
                  !0 === c.options.inputSearch &&
                    c.filter(a(this).val().toLowerCase());
              });
        },
        ...
        updatePlacement: function (b, c) {
          ...
          if (
            (this.popover.removeClass(
              "inline topLeftCorner topLeft top topRight topRightCorner rightTop right rightBottom bottomRight bottomRightCorner bottom bottomLeft bottomLeftCorner leftBottom left leftTop"
            ),
            "object" == typeof b)
          )
        ...
        setValue: function (a) {
          ...
          return !1 !== b
            ? ((this.iconpickerValue = b),
              this._trigger("iconpickerSetValue", { iconpickerValue: b }),
              this.iconpickerValue)
        ...
        getSourceValue: function (a) {
          ...
          return (
            (b = this.hasInput()
              ? this.input.val()
              : this.element.data("iconpickerValue")),
            (void 0 !== b && "" !== b && null !== b && !1 !== b) || (b = a),
            b
          );
        },
        hasInput: function () {
        ...
        update: function (a, b) {
          return (
            (a = a || this.getSourceValue(this.iconpickerValue)),
            ...
            !0 === b
              ...
              : ((a = this.setSourceValue(a)),
                this._updateFormGroupStatus(!1 !== a)),
            !1 !== a && this._updateComponents(),
      ...
      (a.fn.iconpicker = function (b) {
        return this.each(function () {
          var d = a(this);
          d.data("iconpicker") ||
            d.data("iconpicker", new c(this, "object" == typeof b ? b : {}));
        });
      }),
      (c.defaultOptions = a.extend(c.defaultOptions, {
        icons: [
          ...
          { title: "fas fa-adjust", searchTerms: ["contrast"] },
          ...
          { title: "fas fa-align-center", searchTerms: ["middle", "text"] },
          { title: "fas fa-align-justify", searchTerms: ["text"] },
          { title: "fas fa-align-left", searchTerms: ["text"] },
          ...
          { title: "fab fa-android", searchTerms: ["robot"] },
          { title: "fab fa-angellist", searchTerms: [] },
          { title: "fas fa-angle-double-down", searchTerms: ["arrows"] },
          {
          ...
          { title: "fas fa-angle-down", searchTerms: ["arrow"] },
          {
          ...
          { title: "fab fa-apple", searchTerms: ["osx", "food"] },
          ...
          { title: "fas fa-arrow-circle-up", searchTerms: [] },
          { title: "fas fa-arrow-down", searchTerms: ["download"] },
          { title: "fas fa-arrow-left", searchTerms: ["previous", "back"] },
          { title: "fas fa-arrow-right", searchTerms: ["next", "forward"] },
          ...
          { title: "fa-solid fa-file-certificate", searchTerms: [] },
          { title: "fas fa-arrows-alt-h", searchTerms: ["resize", "arrows-h"] },
          { title: "fas fa-arrows-alt-v", searchTerms: ["resize", "arrows-v"] },
          { title: "fas fa-assistive-listening-systems", searchTerms: [] },
          { title: "fas fa-asterisk", searchTerms: ["details"] },
          { title: "fab fa-asymmetrik", searchTerms: [] },
          { title: "fas fa-at", searchTerms: ["email", "e-mail"] },
          ...
          { title: "fas fa-backward", searchTerms: ["rewind", "previous"] },
          { title: "fas fa-balance-scale", searchTerms: [] },
          {
            title: "fas fa-ban",
            searchTerms: [
              "delete",
          ...
          { title: "fas fa-bolt", searchTerms: ["lightning", "weather"] },
          { title: "fas fa-bomb", searchTerms: [] },
          { title: "fas fa-book", searchTerms: ["read", "documentation"] },
          { title: "fas fa-bookmark", searchTerms: ["save"] },
          { title: "far fa-bookmark", searchTerms: ["save"] },
          { title: "fas fa-bowling-ball", searchTerms: [] },
          { title: "fas fa-box", searchTerms: [] },
          { title: "fas fa-boxes", searchTerms: [] },
          ...
          { title: "fas fa-bug", searchTerms: ["report", "insect"] },
          {
          ...
          { title: "fas fa-bus", searchTerms: ["vehicle"] },
          ...
          { title: "fas fa-calendar-check", searchTerms: ["ok"] },
          { title: "far fa-calendar-check", searchTerms: ["ok"] },
          ...
          { title: "fas fa-calendar-times", searchTerms: [] },
          { title: "far fa-calendar-times", searchTerms: [] },
          {
            title: "fas fa-camera",
          ...
          { title: "fas fa-car", searchTerms: ["vehicle"] },
          {
          ...
          { title: "fas fa-caret-up", searchTerms: ["triangle up", "arrow"] },
          { title: "fas fa-cart-arrow-down", searchTerms: ["shopping"] },
          { title: "fas fa-cart-plus", searchTerms: ["add", "shopping"] },
          { title: "fab fa-cc-amazon-pay", searchTerms: [] },
          { title: "fab fa-cc-amex", searchTerms: ["amex"] },
          ...
          { title: "fas fa-certificate", searchTerms: ["badge", "star"] },
          {
          ...
          { title: "far fa-clipboard", searchTerms: ["paste"] },
          ...
          { title: "fas fa-cogs", searchTerms: ["settings", "gears"] },
          {
          ...
          { title: "fas fa-crosshairs", searchTerms: ["picker", "gpd"] },
          { title: "fab fa-css3", searchTerms: ["code"] },
          { title: "fab fa-css3-alt", searchTerms: [] },
          { title: "fas fa-cube", searchTerms: ["package"] },
          { title: "fas fa-cubes", searchTerms: ["packages"] },
          { title: "fas fa-cut", searchTerms: ["scissors", "scissors"] },
          ...
          { title: "fas fa-dna", searchTerms: ["double helix", "helix"] },
          { title: "fab fa-dochub", searchTerms: [] },
          { title: "fab fa-docker", searchTerms: [] },
          { title: "fas fa-dollar-sign", searchTerms: ["usd", "price"] },
          { title: "fas fa-dolly", searchTerms: [] },
          { title: "fas fa-dolly-flatbed", searchTerms: [] },
          {
          ...
          { title: "fab fa-edge", searchTerms: ["browser", "ie"] },
          {
            title: "fas fa-edit",
          ...
          { title: "fas fa-ellipsis-h", searchTerms: ["dots"] },
          { title: "fas fa-ellipsis-v", searchTerms: ["dots"] },
          ...
          { title: "fas fa-eye", searchTerms: ["show", "visible", "views"] },
          ...
          { title: "fas fa-file-archive", searchTerms: [] },
          { title: "far fa-file-archive", searchTerms: [] },
          ...
          { title: "fas fa-filter", searchTerms: ["funnel", "options"] },
          { title: "fas fa-fire", searchTerms: ["flame", "hot", "popular"] },
          { title: "fas fa-fire-extinguisher", searchTerms: [] },
          { title: "fab fa-firefox", searchTerms: ["browser"] },
          ...
          { title: "fas fa-gamepad", searchTerms: ["controller"] },
          {
            title: "fas fa-gavel",
            searchTerms: ["judge", "lawyer", "opinion", "hammer"],
          },
          { title: "fas fa-gem", searchTerms: ["diamond"] },
          { title: "far fa-gem", searchTerms: ["diamond"] },
          ...
          { title: "fas fa-gift", searchTerms: ["present"] },
          { title: "fab fa-git", searchTerms: [] },
          { title: "fab fa-git-square", searchTerms: [] },
          ...
          { title: "fas fa-golf-ball", searchTerms: [] },
          ...
          { title: "far fa-hand-paper", searchTerms: ["stop"] },
          ...
          { title: "far fa-hand-pointer", searchTerms: ["select"] },
          ...
          { title: "fas fa-heading", searchTerms: ["header", "header"] },
          {
            title: "fas fa-headphones",
            searchTerms: ["sound", "listen", "music", "audio"],
          },
          { title: "fas fa-heart", searchTerms: ["love", "like", "favorite"] },
          { title: "far fa-heart", searchTerms: ["love", "like", "favorite"] },
          { title: "fas fa-heartbeat", searchTerms: ["ekg", "vital signs"] },
          { title: "fab fa-hips", searchTerms: [] },
          { title: "fab fa-hire-a-helper", searchTerms: [] },
          { title: "fas fa-history", searchTerms: [] },
          { title: "fas fa-hockey-puck", searchTerms: [] },
          { title: "fas fa-home", searchTerms: ["main", "house"] },
          ...
          { title: "fas fa-industry", searchTerms: ["factory"] },
          {
            title: "fas fa-info",
          ...
          { title: "fab fa-internet-explorer", searchTerms: ["browser", "ie"] },
          { title: "fab fa-ioxhost", searchTerms: [] },
          { title: "fas fa-italic", searchTerms: ["italics"] },
          ...
          { title: "fab fa-js-square", searchTerms: [] },
          { title: "fab fa-jsfiddle", searchTerms: [] },
          { title: "fas fa-key", searchTerms: ["unlock", "password"] },
          { title: "fas fa-keyboard", searchTerms: ["type", "input"] },
          { title: "far fa-keyboard", searchTerms: ["type", "input"] },
          ...
          { title: "fab fa-lastfm-square", searchTerms: [] },
          { title: "fas fa-leaf", searchTerms: ["eco", "nature", "plant"] },
          { title: "fab fa-leanpub", searchTerms: [] },
          { title: "fas fa-lemon", searchTerms: ["food"] },
          { title: "far fa-lemon", searchTerms: ["food"] },
          { title: "fab fa-less", searchTerms: [] },
          { title: "fas fa-level-down-alt", searchTerms: ["level-down"] },
          { title: "fas fa-level-up-alt", searchTerms: ["level-up"] },
          { title: "fas fa-life-ring", searchTerms: ["support"] },
          { title: "far fa-life-ring", searchTerms: ["support"] },
          { title: "fas fa-lightbulb", searchTerms: ["idea", "inspiration"] },
          { title: "far fa-lightbulb", searchTerms: ["idea", "inspiration"] },
          { title: "fab fa-line", searchTerms: [] },
          { title: "fas fa-link", searchTerms: ["chain"] },
          ...
          { title: "fab fa-linux", searchTerms: ["tux"] },
          { title: "fas fa-lira-sign", searchTerms: ["try", "turkish", "try"] },
          {
            title: "fas fa-list",
            searchTerms: [
              "ul",
          ...
          { title: "fas fa-low-vision", searchTerms: [] },
          ...
          { title: "fas fa-mobile-alt", searchTerms: ["mobile"] },
          ...
          { title: "fas fa-motorcycle", searchTerms: ["vehicle", "bike"] },
          { title: "fas fa-mouse-pointer", searchTerms: ["select"] },
          { title: "fas fa-music", searchTerms: ["note", "sound"] },
          { title: "fab fa-napster", searchTerms: [] },
          { title: "fas fa-neuter", searchTerms: [] },
          { title: "fas fa-newspaper", searchTerms: ["press", "article"] },
          ...
          { title: "far fa-object-group", searchTerms: ["design"] },
          { title: "fas fa-object-ungroup", searchTerms: ["design"] },
          { title: "far fa-object-ungroup", searchTerms: ["design"] },
          { title: "fab fa-odnoklassniki", searchTerms: [] },
          { title: "fab fa-odnoklassniki-square", searchTerms: [] },
          ...
          { title: "fas fa-paperclip", searchTerms: ["attachment"] },
          { title: "fas fa-paragraph", searchTerms: [] },
          { title: "fas fa-paste", searchTerms: ["copy", "clipboard"] },
          { title: "fab fa-patreon", searchTerms: [] },
          { title: "fas fa-pause", searchTerms: ["wait"] },
          { title: "fas fa-pause-circle", searchTerms: [] },
          { title: "far fa-pause-circle", searchTerms: [] },
          { title: "fas fa-paw", searchTerms: ["pet"] },
          ...
          { title: "fas fa-pills", searchTerms: ["medicine", "drugs"] },
          ...
          { title: "fas fa-play-circle", searchTerms: ["start", "playing"] },
          { title: "far fa-play-circle", searchTerms: ["start", "playing"] },
          { title: "fab fa-playstation", searchTerms: [] },
          { title: "fas fa-plug", searchTerms: ["power", "connect"] },
          {
            title: "fas fa-plus",
          ...
          { title: "fas fa-pound-sign", searchTerms: ["gbp", "gbp"] },
          { title: "fas fa-power-off", searchTerms: ["on"] },
          ...
          { title: "fas fa-qrcode", searchTerms: ["scan"] },
          {
          ...
          { title: "fas fa-random", searchTerms: ["sort", "shuffle"] },
          ...
          { title: "fab fa-reddit-square", searchTerms: [] },
          {
            title: "fas fa-redo",
            searchTerms: ["forward", "repeat", "repeat"],
          },
          { title: "fas fa-redo-alt", searchTerms: ["forward", "repeat"] },
          { title: "fas fa-registered", searchTerms: [] },
          { title: "far fa-registered", searchTerms: [] },
          { title: "fab fa-rendact", searchTerms: [] },
          ...
          { title: "fas fa-rss", searchTerms: ["blog"] },
          { title: "fas fa-rss-square", searchTerms: ["feed", "blog"] },
          { title: "fas fa-ruble-sign", searchTerms: ["rub", "rub"] },
          { title: "fas fa-rupee-sign", searchTerms: ["indian", "inr"] },
          { title: "fab fa-safari", searchTerms: ["browser"] },
          { title: "fab fa-sass", searchTerms: [] },
          { title: "fas fa-save", searchTerms: ["floppy", "floppy-o"] },
          { title: "far fa-save", searchTerms: ["floppy", "floppy-o"] },
          ...
          { title: "fas fa-share-alt-square", searchTerms: [] },
          { title: "fas fa-share-square", searchTerms: ["social", "send"] },
          { title: "far fa-share-square", searchTerms: ["social", "send"] },
          { title: "fas fa-shekel-sign", searchTerms: ["ils", "ils"] },
          { title: "fas fa-shield-alt", searchTerms: ["shield"] },
          { title: "fas fa-ship", searchTerms: ["boat", "sea"] },
          { title: "fas fa-shipping-fast", searchTerms: [] },
          { title: "fab fa-shirtsinbulk", searchTerms: [] },
          { title: "fas fa-shopping-bag", searchTerms: [] },
          { title: "fas fa-shopping-basket", searchTerms: [] },
          {
          ...
          { title: "fas fa-signal", searchTerms: ["graph", "bars", "status"] },
          ...
          { title: "fab fa-slack", searchTerms: ["hashtag", "anchor", "hash"] },
          {
            title: "fab fa-slack-hash",
            searchTerms: ["hashtag", "anchor", "hash"],
          },
          { title: "fas fa-sliders-h", searchTerms: ["settings", "sliders"] },
          ...
          { title: "fas fa-space-shuttle", searchTerms: [] },
          ...
          { title: "far fa-square", searchTerms: ["block", "box"] },
          ...
          { title: "fas fa-sticky-note", searchTerms: [] },
          { title: "far fa-sticky-note", searchTerms: [] },
          { title: "fas fa-stop", searchTerms: ["block", "box", "square"] },
          { title: "fas fa-stop-circle", searchTerms: [] },
          { title: "far fa-stop-circle", searchTerms: [] },
          { title: "fas fa-stopwatch", searchTerms: ["time"] },
          { title: "fab fa-strava", searchTerms: [] },
          { title: "fas fa-street-view", searchTerms: ["map"] },
          ...
          { title: "fas fa-subway", searchTerms: [] },
          {
          ...
          { title: "fas fa-superscript", searchTerms: ["exponential"] },
          { title: "fab fa-supple", searchTerms: [] },
          {
            title: "fas fa-sync",
            searchTerms: ["reload", "refresh", "refresh"],
          },
          { title: "fas fa-sync-alt", searchTerms: ["reload", "refresh"] },
          { title: "fas fa-syringe", searchTerms: ["immunizations", "needle"] },
          {
            title: "fas fa-table",
            searchTerms: ["data", "excel", "spreadsheet"],
          },
          { title: "fas fa-table-tennis", searchTerms: [] },
          { title: "fas fa-tablet", searchTerms: ["ipad", "device"] },
          { title: "fas fa-tablet-alt", searchTerms: ["tablet"] },
          {
            title: "fas fa-tachometer-alt",
            searchTerms: ["tachometer", "dashboard"],
          },
          { title: "fas fa-tag", searchTerms: ["label"] },
          { title: "fas fa-tags", searchTerms: ["labels"] },
          {
            title: "fas fa-tasks",
            searchTerms: [
              "progress",
          ...
          { title: "fas fa-taxi", searchTerms: ["vehicle"] },
          ...
          { title: "fas fa-thermometer-empty", searchTerms: ["status"] },
          { title: "fas fa-thermometer-full", searchTerms: ["status"] },
          { title: "fas fa-thermometer-half", searchTerms: ["status"] },
          { title: "fas fa-thermometer-quarter", searchTerms: ["status"] },
          {
          ...
          { title: "fas fa-times-circle", searchTerms: ["close", "exit", "x"] },
          { title: "far fa-times-circle", searchTerms: ["close", "exit", "x"] },
          {
            title: "fas fa-tint",
            searchTerms: ["raindrop", "waterdrop", "drop", "droplet"],
          },
          { title: "fas fa-toggle-off", searchTerms: ["switch"] },
          { title: "fas fa-toggle-on", searchTerms: ["switch"] },
          { title: "fas fa-trademark", searchTerms: [] },
          { title: "fas fa-train", searchTerms: [] },
          { title: "fas fa-transgender", searchTerms: ["intersex"] },
          ...
          { title: "fab fa-tripadvisor", searchTerms: [] },
          {
            title: "fas fa-trophy",
            searchTerms: ["award", "achievement", "cup", "winner", "game"],
          },
          { title: "fas fa-truck", searchTerms: ["shipping"] },
          ...
          { title: "fab fa-twitter", searchTerms: ["tweet", "social network"] },
          {
          ...
          { title: "fas fa-undo", searchTerms: ["back"] },
          { title: "fas fa-undo-alt", searchTerms: ["back"] },
          ...
          { title: "fas fa-upload", searchTerms: ["import"] },
          ...
          { title: "fas fa-user-plus", searchTerms: ["sign up", "signup"] },
          {
            title: "fas fa-user-secret",
            searchTerms: ["whisper", "spy", "incognito", "privacy"],
          },
          { title: "fas fa-user-times", searchTerms: [] },
          {
            title: "fas fa-users",
          ...
          { title: "fab fa-viadeo-square", searchTerms: [] },
          ...
          { title: "fab fa-vimeo-square", searchTerms: [] },
          ...
          { title: "fas fa-weight", searchTerms: ["scale"] },
          { title: "fab fa-weixin", searchTerms: [] },
          { title: "fab fa-whatsapp", searchTerms: [] },
          { title: "fab fa-whatsapp-square", searchTerms: [] },
          ...
          { title: "far fa-window-close", searchTerms: [] },
          ...
          { title: "fas fa-won-sign", searchTerms: ["krw", "krw"] },
          ...
          { title: "fab fa-xing-square", searchTerms: [] },
          ...
          { title: "fas fa-yen-sign", searchTerms: ["jpy", "jpy"] },
